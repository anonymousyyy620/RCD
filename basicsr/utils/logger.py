...
class MessageLogger():
    ...
    def __init__(self, opt, logger, start_iter=1, tb_logger=None):
        ...
        self.logger = logger#get_root_logger(log_file=log_file)
        ...
        for k, v in log_vars.items():
            ...
            if self.use_tb_logger and 'debug' not in self.exp_name:
                ...
                if k.startswith('l_'):
                    ...
                    self.tb_logger.add_scalar('learning rate', lrs[0], current_iter)
