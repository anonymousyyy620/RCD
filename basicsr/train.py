...
def main():
    ...
    msg_logger = MessageLogger(opt, logger, current_iter, tb_logger)
    ...
    while current_iter <= total_iters:
        ...
        while train_data is not None:
            ...
            result_code = model.optimize_parameters(current_iter, tb_logger, opt['train'].get('dcr'), if_tb=current_iter % opt['logger']['print_freq']==0)
